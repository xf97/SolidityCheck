...
const string ReAexe = "	Aexe=0;";
const string ReBexe = "	Bexe=0;";
...
const string AEXE = "	uint256 public Aexe=0;";
const string BEXE = "	uint256 public Bexe=0;";
