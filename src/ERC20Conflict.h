...
const static string EC_ERC721 = "ERC721";
const static string EC_ERC165 = "ERC165";
...
const static string EC_isApprovedForAll = "isApprovedForAll";
const static string EC_supportsInterface = "supportsInterface";
...
const static string EC_RE_ERC721 = "(\\s)*((contract)|(interface))(\\s)+(\\w)*((ERC)|(ERc)|(eRC)|(eRc)|(ErC)|(Erc)|(erC)|(erc))(721)(\\w)*((\\s)|(\\{)|(;))";
const static string EC_RE_ERC165 = "(\\s)*((contract)|(interface))(\\s)+(\\w)*((ERC)|(ERc)|(eRC)|(eRc)|(ErC)|(Erc)|(erC)|(erc))(165)(\\w)*((\\s)|(\\{)|(;))";
...
protected:
    ...
    bool IsERC721(const string& _str);
    bool IsERC165(const string& _str);
