...
const static string RF_RE_FALLBACK = "(\\b)(function)(\\s)*(\\()(\\s)*(\\))(\\s)+(.)*(payable)(\\s)*";
const static string RF_RE_THROW = "((throw)|(revert(\\()(\\))))";
//const static string RF_RE_FALLFACK_FUNCTION_HEAD = "(\\b)(function)(\\b)(\\s)*(\\()(\\s)*(\\))(\\s)+((external)|(public)|(internal)|(private))?(\\s)+(payable)(\\s)+((external)|(public)|(internal)|(private))?(\\s)*{";
