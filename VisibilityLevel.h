...
const static string VL_PUBLIC3 = " public {";
const static string VL_PRIVATE3 = " private {";
const static string VL_INTERNAL3 = " internal {";
const static string VL_EXTERNAL3 = " external {";
...
protected:
    ...
    bool IsVisibility3(string _str);
